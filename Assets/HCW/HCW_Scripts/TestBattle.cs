...
public class TestBattle : MonoBehaviour
{
	void Start()
	{
		...
		// 플레이어 포켓몬
		var pikachu = new Pokemon ("Pikachu", maxHp: 100, speed: 30, skills: new List<Skill> { fireball, tackle });
			
		

		// 상대 포켓몬
		var eevee = new Pokemon("Eevee", maxHp: 80, speed: 25, skills: new List<Skill> { fireball, tackle });
